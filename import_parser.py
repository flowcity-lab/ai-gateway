"""
import_parser.py — Intelligenter Import: Datei-Parser und Telefon-Normalisierung
...
class ParseRequest(BaseModel):
    ...
    file_name: str
    file_type: Optional[str] = None  # wird aus file_name abgeleitet wenn nicht gesetzt

class NormalizePhoneRequest(BaseModel):
    phones: list[str]
    fallback_country: Optional[str] = None  # ISO 3166-1: AT, DE, CH, ...
    # Kandidaten-Länder für Ambiguous-Detection (leer = alle EU-Länder)
